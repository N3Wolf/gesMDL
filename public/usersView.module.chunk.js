...
var UsersViewComponent = (function () {
    function UsersViewComponent(
        ...
        router, route, usersService, ngbDateParserFormatter) {
        this.router = router;
        this.route = route;
    ...
    UsersViewComponent.prototype.ngOnInit = function () {
        ...
        if (!this.isInsert) {
            ...
            this.usersService.getUserById(this.idRecord).subscribe(function (result) {
                ...
                if (_this.User.dataCadastro) {
                    _this.User.arrayDataAssociacao = _this.ngbDateParserFormatter.parse(_this.User.dataAssociacao);
                }
                console.log('this.User');
    ...
    UsersViewComponent.prototype.onUsersSubmit = function () {
        var _this = this;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__classes_myNgbDateParserFormatter__ = __webpack_require__("../../../../../src/app/classes/myNgbDateParserFormatter.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__datepicker_config_datepicker_config_component__ = __webpack_require__("../../../../../src/app/theme/pages/default/components/datepicker-config/datepicker-config.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
usersViewModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            { provide: __WEBPACK_IMPORTED_MODULE_9__ng_bootstrap_ng_bootstrap__["b" /* NgbDateParserFormatter */], useClass: __WEBPACK_IMPORTED_MODULE_10__classes_myNgbDateParserFormatter__["a" /* MyNgbDateParserFormatter */] }
        ], exports: [
            __WEBPACK_IMPORTED_MODULE_3__angular_router__["RouterModule"]
        ], declarations: [
            __WEBPACK_IMPORTED_MODULE_6__usersView_component__["a" /* UsersViewComponent */],
            __WEBPACK_IMPORTED_MODULE_11__datepicker_config_datepicker_config_component__["a" /* DatepickerConfigComponent */]
        ]
    })
], usersViewModule);
